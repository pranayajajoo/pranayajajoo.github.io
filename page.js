var data = {
    ...
    "projects": [
        {
            img: 'images/',
            title: 'GSCMI Conference held at Purdue University',
            text: [
                    ['Selected to represent UIUC at the Global Supply Chain Management Initiative (GSCMI) Case Competition to develop a strategy to transform a company\'s global supply chain to accommodate changing production and transportation costs and exchange rates while maintaining steady sales.']
                  ]
        },
        {
            img: 'images/',
            title: 'British Petroleum Professional Responsibility Strategy Competition 2019 | First Runner Up',
            text: [
                    ['Scraped data from web on energy usage and carbon dioxide emissions from various companies. Learned an inverse model attributing importance to features using Shapley values.'],
                    ['Presented a data-backed insight and strategy on transforming the business to optimize for these quantities within practical constraints.']
                  ]
        },
        {
            img: 'images/',
            title: 'Automatic Traffic Control using Computer Vision | Bachelor Thesis',
            text: [
                    ['Worked on a project to address the vehicular traffic problems in Mumbai by devising an effective system using data collected from 11 traffic signal cameras and applying object detection and tracking techniques to identify traffic patterns.']
                  ]
        }],
    "volunteering": [
        {
            img: 'images/',
            title: 'Rubik\'s Cube Mumbai Open (RCMO), RCMO Head 2017-2018',
            text: 'Led a team of 50+ students to conduct an international cubing competition and to organize two workshops with over 60 participants; oversaw \textit{two national records in the Limca Book of Records} with my team.'
        }],
    "teaching": [
        {
            img: 'images/',
